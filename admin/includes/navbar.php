    ...
    <ul class="navbar-nav nav-center site-logo">
        <li>
            <a href="index.php">
                ...
                <span class="brand-text">TAYMAC</span>
            </a>
        </li>
    </ul>
...
<nav class="top-toolbar navbar navbar-mobile flex-nowrap">
    <!-- START LEFT DROPDOWN MENUS -->


    <ul class="navbar-nav nav-left">

        <li class="nav-item dropdown-menu-lg toggle_sidebar">
            <a href="javascript:void(0)"
               role="button" aria-haspopup="true" aria-expanded="false">
                <i class="icon dripicons-view-apps"
    ...
    <span style="color: #ffffff;text-align: center !important;">
       TAYMAC ADMIN SYSTEM
    </span>
    ...
    <ul class="navbar-nav nav-right">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link nav-pill user-avatar has-arrow" data-toggle="dropdown" href="#" role="button"
               aria-haspopup="true" aria-expanded="false">
                <img src="img/logo/ahpc_logo.png" class="w-35 rounded-circle" alt="AHPC Logo">
            </a>
